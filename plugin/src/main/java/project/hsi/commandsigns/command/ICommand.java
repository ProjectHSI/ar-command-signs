...
public interface ICommand {
     ...
     *
     * @param sender The user that needs the usage information
     */
     ...
     *
     * @param sender     The user that needs the usage information
     * @param permission Do we have to consider that the user has the permission of the command's usage
     */
     ...
     * @return <code>true</code> if the given String matches the command
     ...
     * @param args   The args that the sender sent (without the first arg being the
     *               subcommand)
     ...
     *
     * @param sender The user that we want to check
